...
const { verificaCamposVazios } = require('./validacoes');
const rotas = express();

rotas.get('/contas', listarContas);
rotas.post('/contas', verificaCamposVazios, criarConta);
rotas.put('/contas/:numeroConta/usuario', verificaCamposVazios, atualizarUsuario);
